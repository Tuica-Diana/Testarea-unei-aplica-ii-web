...
class Instagram_bot(unittest.TestCase):
    ...
    #functia care realizeaza logarea pe cont
    def test_login_instagram(self):
        ...
        #se apasa optiunea "accept all"
        driver.find_element_by_xpath("/html/body/div[2]/div/div/button[1]").click()
        time.sleep(2)

        #se identifica si se introduc username-ul si parola in campurile specifice
...
#functia main in care sunt apelate restul functiilor
